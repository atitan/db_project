	...
	<div class="panel panel-primary">
		...
		<div class="table-responsive">
          ...
          <input type="text" name="address" class="form-control" value="{{ $order->address }}" style="display: none;"></td>
						...
						<td nowrap="nowrap" class="text-center"><a href="/orders/{{ $order->id }}" style="text-decoration: none; margin-right: 8px;"><span><i class="fa fa-info-circle fa-fw"></i> 檢視訂單</span></a><br/>
