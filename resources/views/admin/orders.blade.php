	  	  	...
	  	  	@foreach ($orders as $order)
	  			<tr>
	  				...
	  				<td class="text-center" nowrap="nowrap">
	  					<a href="/admin/orders/{{ $order->id }}" style="margin-right: 8px; text-decoration: none;"><span><i class="fa fa-info-circle fa-fw"></i> 檢視</span></a><br/>
	  					<a onclick="editOrder(this)" class="cursor" style="margin-right: 8px; text-decoration: none; color: green;"><span><i class="fa fa-pencil fa-fw"></i> 編輯</span></a>
	  					...
	  					<a onclick="deleteOrder(this)" class="cursor" style="text-decoration: none; color: red; word-wrap:no-warp;"><span><i class="fa fa-trash-o fa-fw"></i> 刪除</span></a></span>
	  				</td>
	  			</tr>
	  	  	@endforeach
	  	  	</tbody>
