...
@section('content')
	...
	<div class="panel panel-primary">
	  ...
	  <div class="table-responsive">
	  	  <table class="table table-hover" id="adminOrders">
	  	  	<thead>
	  	  		<tr>
	  	  	...
	  	  	@foreach ($orders as $order)
	  			<tr>
	  				...
	  				<td class="text-center" nowrap="nowrap">
	  					<a href="/admin/orders/{{ $order->id }}" style="margin-right: 8px; text-decoration: none; color: #727272;"><span><i class="fa fa-info-circle fa-fw"></i> 檢視</span></a><br/>
	  					<a onclick="editOrder(this)" class="cursor" style="margin-right: 8px; text-decoration: none; color: #158cda;"><span><i class="fa fa-pencil fa-fw"></i> 編輯</span></a>
	  					...
	  					<a onclick="deleteOrder(this)" class="cursor" style="text-decoration: none; color: red; word-wrap:no-warp;"><span><i class="fa fa-trash-o fa-fw"></i> 刪除</span></a>
	  				</td>
	  			</tr>
	  	  	@endforeach
	  	  	</tbody>
